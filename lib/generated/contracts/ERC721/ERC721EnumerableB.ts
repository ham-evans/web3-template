...
export interface ERC721EnumerableBInterface extends utils.Interface {
  functions: {
...
export interface ERC721EnumerableB extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721EnumerableBInterface;
